...
from routen_berechnung import routenplanung, reconstruct_route_details, find_start_index, load_station_departures_pickle, save_station_departures_pickle, create_station_departures_from_db
...
def replan(abschnitt, route, station_departures):
    ...
    if neue_routen:
        ...
        index_umsteigeabschnitt = next((i for i, abschn in enumerate(route)
                                        if abschn["station_name_to"] == umsteigeort), None)
